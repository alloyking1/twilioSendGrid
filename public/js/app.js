              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.data.emailBody,
                  expression: "data.emailBody"
                }
              ],
              staticClass: "form-control",
              attrs: { placeholder: "Enter email body" },
              domProps: { value: _vm.data.emailBody },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.data, "emailBody", $event.target.value)
                }
              }
            })
          ]),
...
__webpack_require__(/*! C:\Users\User\Desktop\desktop\projects_new\writing_projects\twilioSendGrid\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\User\Desktop\desktop\projects_new\writing_projects\twilioSendGrid\resources\sass\app.scss */"./resources/sass/app.scss");
